...
import com.gundulsoftware.gundulapps.AppController;
...
//                String url = alamat_url_gambar;
//                makeImageRequest(url);
//            }
//        });
//
//        btnImageReq2.setOnClickListener(new View.OnClickListener() {
//
//            @Override
//            public void onClick(View v) {
//                String url = "https://lh6.googleusercontent.com/Pd1FW6fio7xt_OMyBvgSVqM7wpiMNcz6_c6vugh8uU6-EXuyk529EHbqHOIOWahoLKtmAQ=w200-h150-p-k-nu";
//                makeImageRequest(url);
//            }
//        });
    }
...
//            textMapel.setText("Sejarah");
    ...
    private void hitungNilai() {
        ...
        Intent intentMp = new Intent(this, EvaluasiActivity.class);
    ...
    private void getURL(final int idSoal) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                ReferenceUrl.URL_GET_SOAL, new Response.Listener<String>() {
...
//                    "soal :" + noSoal + "jawaban: " + String.valueOf(radioButton.getText()), Toast.LENGTH_SHORT).show();
    ...
    private void setWarnaNomorSoal(int noSoal) {
        ...
        {
            case 1:
                btnSoal1.setBackgroundColor(Color.BLUE);
                break;
            case 2:
                btnSoal2.setBackgroundColor(Color.BLUE);
                break;
            case 3:
                btnSoal3.setBackgroundColor(Color.BLUE);
                break;
            case 4:
                btnSoal4.setBackgroundColor(Color.BLUE);
                break;
            case 5:
                btnSoal5.setBackgroundColor(Color.BLUE);
                break;
            case 6:
                btnSoal6.setBackgroundColor(Color.BLUE);
                break;
            case 7:
                btnSoal7.setBackgroundColor(Color.BLUE);
                break;
            case 8:
                btnSoal8.setBackgroundColor(Color.BLUE);
                break;
            case 9:
                btnSoal9.setBackgroundColor(Color.BLUE);
                break;
            case 10:
                btnSoal10.setBackgroundColor(Color.BLUE);
                break;
        }
    }
    ...
    private void makeImageRequest(String jawaban, int noSoal) {
        ...
        imageLoader.get(ReferenceUrl.IP_SERVER+url, ImageLoader.getImageListener(imageView,500,500));

        Cache cache = AppController.getInstance().getRequestQueue().getCache();
        Entry entry = cache.get(ReferenceUrl.IP_SERVER+url);
        if(entry != null){
            try {
    ...
    public class CountDown extends CountDownTimer {
        ...
        public void onFinish() {
            Toast.makeText(SoalActivity.this, "Waktu Habis", Toast.LENGTH_SHORT).show();
            hitungNilai();
        }
    }
